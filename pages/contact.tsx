    ...
    <div className="flex min-h-screen bg-gray-50">
      ...
      <main className="flex-1 p-10">
        <section className="max-w-3xl">
          <h2 className="text-4xl font-semibold text-gray-800 mb-4">Contactinformatie</h2>
          <p className="text-gray-700 text-lg mb-6">
            Heb je vragen of wil je meer informatie? Neem gerust contact met ons op.
          </p>
          <div className="bg-white p-6 rounded-lg shadow-md space-y-4">
            <p><strong>Telefoon:</strong> <a href="tel:+31611170964" className="text-blue-600 hover:underline">+31 6 11170964</a></p>
            <p><strong>E-mailadres:</strong> <a href="mailto:info@unicarenl.nl" className="text-blue-600 hover:underline">info@unicarenl.nl</a></p>
            <p><strong>Locatie:</strong> Amsterdam, Nederland</p>
          </div>
        </section>
      </main>
